 ...
 * Board identifier.
 */
#define BOARD_RNA_STML433CC
#define BOARD_NAME                  "RNA STM32L433CC based PCB"
 ...
 */
#define LINE_COL1                   PAL_LINE(GPIOA, 0U)
#define LINE_COL2                   PAL_LINE(GPIOA, 1U)
#define LINE_COL3                   PAL_LINE(GPIOA, 2U)
#define LINE_COL4                   PAL_LINE(GPIOA, 3U)
#define LINE_COL5                   PAL_LINE(GPIOA, 4U)
...
#define LINE_I2C2_SCL               PAL_LINE(GPIOB, 6U)
#define LINE_I2C2_SDA               PAL_LINE(GPIOB, 7U)
#define LINE_ROW1                   PAL_LINE(GPIOB, 8U)
#define LINE_ROW2                   PAL_LINE(GPIOB, 9U)
#define LINE_ROW3                   PAL_LINE(GPIOB, 10U)
#define LINE_ROW4                   PAL_LINE(GPIOB, 11U)
#define LINE_ROW5                   PAL_LINE(GPIOB, 12U)
#define LINE_ROW6                   PAL_LINE(GPIOB, 13U)
#define LINE_ROW7                   PAL_LINE(GPIOB, 14U)
#define LINE_BOOT0                  PAL_LINE(GPIOH, 1U)
...
#define PIN_MODE_INPUT(n)          (3U << ((n) * 2U))
 ...
 * PA7  - NOT_USED                  ().
 * PA8  - NOT_USED                  ().
 * PA9  - I2C1_SDA                  (alternate ).
 * PA10 - I2C1_SCL                  (alternate ).
 * PA11 - USB_DM                    (alternate ).
 * PA12 - USB_DP                    (alternate ).
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_PIN8, 0) |         \
                                     PIN_AFIO_AF(GPIOA_PIN9, 4) |         \
                                     PIN_AFIO_AF(GPIOA_PIN10, 4) |         \
 ...
 * PB4  - ARD_D12                   (unused).
 * PB5  - ARD_D11                   (unused).
 * PB6  - I2C2_SCL                  (alternate 4).
 * PB7  - I2C2_SDA                  (alternate 4).
 * PB8  - COL1                      (input pulldown).
 * PB9  - COL2                      (input pulldown).
 * PB10 - COL3                      (input pulldown).
 * PB11 - COL4                      (input pulldown).
 * PB12 - COL5                      (input pulldown).
 * PB13 - COL6                      (input pulldown).
 * PB14 - COL7                      (input pulldown).
 * PB15 - PIN15                     (unused).
 */
