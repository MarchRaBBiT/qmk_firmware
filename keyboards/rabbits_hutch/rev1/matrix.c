...
static matrix_row_t read_cols()
{
    ...
    cols = ((gpio_b & 0x000000E0) >> 5) |
           (gpio_a & 0x00000030) >> 1 | // >> 4 << 3
           ((gpio_b & 0x00000010) << 1) | // >> 4 << 5
           ((gpio_a & 0x0000000C) << 4) | // >> 2 << 6
           ((gpio_a & 0x000000C0) << 2) | // >> 6 << 8
           ((gpio_b & 0x00000008) << 7) | // >> 3 << 10
           ((gpio_a & 0x00008000) >> 4) | // >> 15 << 11
           ((gpio_a & 0x00000400) << 2) | // >> 10 << 12
           ((gpio_a & 0x00000200) << 4) | // >> 9 << 13
           ((gpio_a & 0x00000100) << 6) ; // >> 8 << 14
