...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        // right hand
             ...
             KC_RPRN,                KC_N,   KC_M,  KC_COMM,KC_DOT, KC_SLSH, KC_BSLS,
                                             KC_MEH,KC_LEFT,KC_DOWN,KC_UP,   KC_RGHT,
             KC_DEL,        TG(SYMBOL),
             KC_BSPC,
    ...
    [PSEUDO_US] = KEYMAP(
        // left hand
        KC_FN2,         KC_FN2,  KC_FN2, KC_FN2, KC_FN2, KC_FN2,   TG(MEDIA),
        KC_TAB,         KC_Q,    KC_W,   KC_E,   KC_R,   KC_T,   KC_FN2,
        KC_LCTL,        KC_A,    KC_S,   KC_D,   KC_F,   KC_G,
        OSM(MOD_LSFT),  KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   SHIFT(KC_8),
        KC_HYPR,        KC_RCTL, KC_LALT,KC_LGUI,KC_MHEN,
                                            TG(MEDIA),    KC_PGUP,
                                                          KC_PGDN,
     ...
     LALT(LCTL(KC_DEL)), KC_FN2,   KC_FN2,  KC_FN2,   KC_FN2,  KC_FN2, KC_FN2,
             ...
             SHIFT(KC_9),KC_N,     KC_M,    KC_FN2,   KC_FN2,  KC_SLSH,KC_FN2,
                                   KC_MEH,  KC_LEFT,  KC_DOWN, KC_UP,  KC_RGHT,
             KC_DEL,        TG(SYMBOL),
             KC_BSPC,
             KC_RALT,KC_LCTL, KC_ENT
